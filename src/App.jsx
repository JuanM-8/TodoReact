...
Título original: "${selectedTask.text}"`,
  ...
  const handleGenerateDesc = async () => {
    ...
    try {
      const result = await callClaude(
        `Actúa como un técnico de soporte que redacta tickets de Jira de forma clara y profesional.
Tu tarea es expandir el título proporcionado en una descripción breve del trabajo realizado.
Formato de salida:
Un solo párrafo en español profesional.
Reglas:
- Expande el título de forma natural.
- No inventes información técnica que no esté implícita.
- Usa tono formal de trabajo técnico.
- Indica que se validó el funcionamiento al final.
- Máximo 3 líneas
